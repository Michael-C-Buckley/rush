...
- POSIX pipeline negation with `!`; shell-implemented pipeline stages run in isolated pipeline environments rather than leaking assignments or process-state changes to the parent shell.
