...
- POSIX vi command-line editing still has edge commands tracked separately, including exact repeat/operator-motion edge behavior and broader shell-word expansion cases beyond the covered pathname editing slice.
