...
- `printf` supports common conversions/escapes including signed `%i`, representative floating-point conversions and floating flags under the C locale, POSIX C integer constants, and literal percent formatting, but not full integer/string format grammar or non-C locale details.
