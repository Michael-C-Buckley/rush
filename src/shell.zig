...
pub const ExpansionFailure = expand.ExpansionFailure;
pub const ExpansionErrorKind = expand.ExpansionErrorKind;
...
pub const ShellExpansion = expand.ShellExpansion;
