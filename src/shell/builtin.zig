...
pub const Builtin = struct {
    ...
    pub fn validate(self: Builtin) void {
        ...
        switch (self.semantic_class) {
            ...
            .shell_state => std.debug.assert(std.mem.eql(u8, self.name, ".") or std.mem.eql(u8, self.name, "eval") or std.mem.eql(u8, self.name, "set") or std.mem.eql(u8, self.name, "shift") or std.mem.eql(u8, self.name, "alias") or std.mem.eql(u8, self.name, "unalias") or std.mem.eql(u8, self.name, "trap") or std.mem.eql(u8, self.name, "local") or std.mem.eql(u8, self.name, "read") or std.mem.eql(u8, self.name, "cd") or std.mem.eql(u8, self.name, "abbr") or std.mem.eql(u8, self.name, "exec") or std.mem.eql(u8, self.name, "event") or std.mem.eql(u8, self.name, "interval")),
...
pub const default_builtins = [_]Builtin{
    ...
    Builtin.initWithSemantics("event", .regular, .shell_state),
    ...
    Builtin.initWithSemantics("interval", .regular, .shell_state),
    ...
    Builtin.initWithSemantics("prompt", .regular, .output),
