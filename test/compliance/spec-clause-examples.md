...
| `builtin-printf-dynamic-width-precision`; `builtin-printf-dynamic-combined-width-precision` | `test/corpus/posix` | `builtin-printf`, `builtin-printf-width-precision`, `builtin-printf-dynamic-width-precision` | asterisk width and precision consume integer arguments before representative string and signed-integer conversion operands, including combined dynamic string width/precision and left-adjusted signed integer precision |
