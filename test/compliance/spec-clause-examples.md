...
| `builtin-printf-integer-format-flags`; `builtin-printf-integer-sign-padding` | `test/corpus/posix` | `builtin-printf`, `builtin-printf-numeric-formats`, `builtin-printf-integer-format-flags` | integer conversions honor representative sign, space, alternate-form, precision, field-width, left-adjust, zero-padding flags, and sign/precision padding interactions |
