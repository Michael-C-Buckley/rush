...
| `builtin-printf-integer-format-flags` | `test/corpus/posix` | `builtin-printf`, `builtin-printf-numeric-formats`, `builtin-printf-integer-format-flags` | integer conversions honor representative sign, space, alternate-form, precision, field-width, left-adjust, and zero-padding flags |
