...
| `builtin-printf-dynamic-width-precision` | `test/corpus/posix` | `builtin-printf`, `builtin-printf-width-precision`, `builtin-printf-dynamic-width-precision` | asterisk width and precision consume integer arguments before representative string and signed-integer conversion operands |
