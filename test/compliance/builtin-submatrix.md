...
| `set` | `option-set`, `option-set-short-clusters`, `builtin-set-positionals`, `option-set-usage-errors`, option rows | shell option, clustered short option, and set -- positional parameter corpus; invalid option diagnostics | many POSIX flags and broader operand forms |
