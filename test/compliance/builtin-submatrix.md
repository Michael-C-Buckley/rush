...
| `read` | `builtin-read`, read subrows | backslash, `-r`, `--`, custom/mixed/empty IFS, last-variable remainder assignment, EOF status, option/operand diagnostics | interactive terminal input and continuation prompts |
