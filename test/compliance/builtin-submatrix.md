...
| `getopts` | `builtin-getopts`, `builtin-getopts-explicit-args`, `builtin-getopts-usage-errors` | clusters, required args, silent missing arg, explicit args, invalid optstring and variable-name diagnostics | remaining OPTIND edge cases |
