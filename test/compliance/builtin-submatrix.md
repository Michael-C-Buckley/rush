...
| `printf` | `builtin-printf`, `builtin-printf-usage-errors`, printf subrows | escapes, `%b`/`%c`, format reuse, octal/hex, representative floating conversions, width/precision, missing format, invalid format/conversion, invalid numeric operand diagnostics | POSIX C integer constants and full format grammar/locale details |
