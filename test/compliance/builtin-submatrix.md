...
| `test`, `[` | `builtin-test`, test subrows | file predicates including special file types, string comparisons, integer comparisons, ordering, invalid expression | complete POSIX expression grammar, precedence edge cases |
